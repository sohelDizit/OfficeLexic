...
window.tagsModal = (function($) {
    ...
    function init() {
        ...
        wnd.find('.tag.color .outer .inner').off('click').on('click', function(e) {
            if ($('.tag.color .outer .inner').prop('disabled')) {
                return false;
            }
        ...
        wnd.find('.buttons .del').off('click').on('click', function() {
            if ($('.buttons .del').prop('disabled')) {
                return false;
            }
            hide();
            deleteTag();
        ...
        wnd.find('.buttons .cancel').off('click').on('click', function() {
            if ($('.buttons .cancel').prop('disabled')) {
                return false;
            }
            hide();
            return false;
    ...
    function show(tag, type, options) {
        ...
        saveBtn.off('click')
            .on('click',
                function() {
                    if (saveBtn.prop('disabled') || saveBtn.hasClass('disable')) {
                        return false;
                    }
                    ...
                    if (tag.name.length === 0) {
                        ...
                        wnd.find('#mail_tag_name').trigger("focus");
                        return false;
                    }
        ...
        window.PopupKeyUpActionProvider.EnterAction = "jq('#tagWnd .containerBodyBlock .buttons .save').trigger('click');";
    }

    function showLoader(message) {
        wnd.find('.progressContainer').show();
        wnd.find('.progressContainer .loader').show().html(message || '');
        wnd.find('.save #mail_tag_name').prop("disabled", true);
        wnd.find('.save .tag.color .outer .inner').prop("disabled", true).css('cursor', 'default');
        wnd.find('.save .tag.color').css('cursor', 'default');
        wnd.find('.linked_addresses.save #mail_tag_email').prop("disabled", true);
        wnd.find('.linked_addresses a.plusmail').prop("disabled", true).css('cursor', 'default');
        wnd.find('.removeTagAddress').prop("disabled", true).css('cursor', 'default');
        wnd.find('.buttons .save').prop("disabled", true).removeClass("disable").addClass("disable");
        wnd.find('.buttons .cancel').prop("disabled", true).removeClass("disable").addClass("disable");
    }

    function hideLoader() {
        wnd.find('.progressContainer').hide();
        wnd.find('.save #mail_tag_name').prop("disabled", false);
        wnd.find('.save .tag.color .outer .inner').prop("disabled", false).css('cursor', 'pointer');
        wnd.find('.save .tag.color').css('cursor', 'pointer');
        wnd.find('.linked_addresses.save #mail_tag_email').prop("disabled", false);
        wnd.find('.linked_addresses a.plusmail').prop("disabled", false).css('cursor', 'pointer');
        wnd.find('.removeTagAddress').prop("disabled", false).css('cursor', 'pointer');
        wnd.find('.buttons .save').prop("disabled", false).removeClass("disable");
        wnd.find('.buttons .cancel').prop("disabled", false).removeClass("disable");
    }
    ...
    function hide(error) {
        wnd.find('.buttons .save').off('click');
    ...
    function getTagFromWnd() {
        var id = wnd.attr('tagid'),
            ...
            name = wnd.find('#mail_tag_name').val().trim(),
